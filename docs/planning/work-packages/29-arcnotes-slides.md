...
**[P2-006](../../decisions/phase-2-specification-decisions.md#rule-p2-006) removes slides, presentations, slide generation, frame ordering and presentation navigation from required ArcNotes delivery**, with no mandatory future hook. The [D-006 amendment of 2026-09-06](../../decisions/phase-1-foundation-decisions.md#rule-d-006) records it at decision level, and the glossary entry `ArcNotes.Slides` is retired.
