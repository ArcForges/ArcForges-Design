...
| 33 | Copy First is licence-gated and provenance-gated; unconditional copying is rejected. The nine-field provenance record in [D-013](#rule-d-013) is mandatory before any source, test, asset or generated artifact is copied, translated, ported or structurally reused. | [D-013](#rule-d-013) | T20 | Unchanged; apply the cited authority within the current [P2-012](phase-2-specification-decisions.md#rule-p2-012)/[P2-013](phase-2-specification-decisions.md#rule-p2-013) topology. |
