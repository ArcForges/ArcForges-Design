Below is the **concise overview of ArcForges Stage 0–28**, stating only "what each stage is responsible for."

## I. Stage 0–12: Establishing the Commercial Platform

| Stage | Name | Core Responsibilities |
| --- | --- | --- |
| **0** | **Portfolio / Product / Business Foundation** | Define the overall ArcForges product portfolio, business model, and the general positioning of Local-first + open-source + paid Cloud. |
...
| **2** | **Website / Marketing / Product Surfaces** | Define the official website, product introduction pages, download portals, account portals, and other external product surfaces. |
| **3** | **Billing / Payment** | Define the commercial payment system including payments, subscription purchases, renewals, refunds, etc. |
| **4** | **Entitlement** | Define "what the user purchased and is therefore eligible to use", strictly separated from Feature Flags and permission systems. |
...
| **7** | **Cloud / Mobile / Web** | Define the responsibilities of Cloud, and ArcChat Mobile/Web as Companions rather than full professional standalone Apps. |
...
## II. Stage 13–20: Completely Defining the Four Real Products
...
| **19** | **Unified Agent Execution / Task / Automation Model** | Unify Intent → Task → Run → Step → Attempt → Capability, as well as Pause, Retry, Checkpoint, Approval, Budget, Automation execution semantics. |
| **20** | **ArcSlate Complete Product Specification & Olive-to-C# Rewrite Plan** | Fully define the ArcSlate professional video editing product, and determine how Olive capabilities are retained/improved/discarded, along with C# + Avalonia rewrite boundaries. |
...
| Stage | Name | Core Responsibilities |
| --- | --- | --- |
| **21** | **Cross-App Semantic Capability & Resource Model** | Unify cross-App domain language: App, Instance, Capability, Action, Context, Artifact, ResourceRef, Deep Link, Event, Health, Invocation, Compatibility. |
...
## IV. Stage 25–27: Ensuring Long-Term Safe and Stable Evolution
...
Therefore, the entire **Stage 0–28** sequence forms a clear closed loop:
