...
| `FilterGroup` | `1 operator:Key`; `2 children:NotesFilter[]` | all/any have 1..32 children; not exactly 1. No and/or aliases. |
...
| `MathContent` | `1 tex:string`; `2 display:bool` | Bounded 4096-scalar declarative math; render only, no file/network/macros executing code. |
...
| `ChecksumSpec` | `1 algorithm:Key`; `2 input:ByteRange`; `3 offset:uint32`; `4 byteOrder:Key` | crc16CcittFalse/crc32IsoHdlc; checksum bytes excluded from input; fixed vectors in architecture 26. |
