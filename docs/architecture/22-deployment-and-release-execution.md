...
| MR-02 | **Android release is verified on real devices** ([PM-03](../requirements/12-quality-and-compatibility-contract.md#rule-pm-03) of the quality contract), against the signed RN/Hermes Android release artifact. |
