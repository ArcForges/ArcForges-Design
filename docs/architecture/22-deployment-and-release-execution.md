...
P2-012 current implementation authorities: [D1 migration, capacity and independent recovery](data-model/04-d1-execution-profile.md).
...
| CF-03 | **CI authenticates with application-scoped identity only** ([EN-08](../requirements/products/arcforges-cloud.md#rule-en-08)); no long-lived deployment credential exists to leak. |
