...
| <a id="rule-cf-02"></a>CF-02 | **Configuration files hold references, never long-lived plaintext secrets** ([CS-01](05-cloud-architecture.md#rule-cs-01) of the cloud architecture); production secrets live in a managed vault in RBAC mode with purge protection ([CS-02](05-cloud-architecture.md#rule-cs-02) there). |
