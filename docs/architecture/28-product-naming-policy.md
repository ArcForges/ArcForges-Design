...
Authority: [P2-015](../decisions/phase-2-specification-decisions.md#rule-p2-015), implementing the [portfolio](../requirements/00-product-scope-and-portfolio.md), [glossary](../requirements/01-normative-glossary-and-invariants.md) and [P2-012](../decisions/phase-2-specification-decisions.md#rule-p2-012)/P2-013. Owner: Contracts for policy data/tooling; each product retains its application and format ownership.
