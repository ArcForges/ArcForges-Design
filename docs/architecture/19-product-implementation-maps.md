...
| # | Result |
|---|---|
| VC-01 | **24 evidence-established rows, 6 accepted exclusions, 0 unresolved.** Every non-excluded row above names an ArcForges component and a work package. |
...
| Any UI shared between Avalonia desktop and React Native mobile | **[D-021](../decisions/phase-1-foundation-decisions.md#rule-d-021)**; [AC-23](#rule-ac-23) |
