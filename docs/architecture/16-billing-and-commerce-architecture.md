...
| <a id="rule-eo-04"></a>EO-04 | Entitlement never calls Commerce. Grant source is the closed GR-02 vocabulary: Subscription, CloudPass, StorageAddOn, PurchasedCredit, AdminGrant, Migration, Compensation; each carries its issuing transaction/action reference without a provider identifier. |
