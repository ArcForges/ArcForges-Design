...
| HV-02 | A model-proposed action reaches a real product operation through the full security pipeline | [WP-20.02](../planning/work-packages/20-first-cross-product-workflow.md#rule-wp-20.02); [WP52 real integration](../planning/work-packages/52-cloud-harness.md#rule-wp-52) |
...
| HV-06 | Stale context is detected before a write, and the model is told rather than silently corrected | [WP-20.02](../planning/work-packages/20-first-cross-product-workflow.md#rule-wp-20.02); [WP52 real integration](../planning/work-packages/52-cloud-harness.md#rule-wp-52) |
