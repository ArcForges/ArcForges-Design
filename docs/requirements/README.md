...
| Document | Covers |
|---|---|
| [`00-product-scope-and-portfolio.md`](00-product-scope-and-portfolio.md) | The current three desktop products, embedded assistant and companions, commercial invariants, product independence and deferred cross-product boundary, state ownership, data and control paths, the technology constitution, licensing scope, reference repositories, and the closed list of Architecture Baseline Changes |
