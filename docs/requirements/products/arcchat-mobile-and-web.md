...
| ID-09 | **ArcChat Web is a deployment of the single `ArcForges.Web.App` Blazor WebAssembly codebase** (**[D-007](../../decisions/phase-1-foundation-decisions.md#rule-d-007)**, **[D-014](../../decisions/phase-1-foundation-decisions.md#rule-d-014)**), served at `chat.arcforges.com`. |
