...
The current [P2-006 amendment](../../decisions/phase-2-specification-decisions.md) governs scope. Architecture/planning/assurance references still require reconciliation; these requirements do not certify implementation or Stage 2 closure.
...
| [`arcnotes.md`](arcnotes.md) | **ArcNotes** (`arcnotes`) | Cloud-synchronized native notes: rich documents, references, basic properties/table/list views and durable cached work; no whiteboard, slides or collaboration (**P2-006**) |
...
|---|---|---|
| [`arcforges-cloud.md`](arcforges-cloud.md) | **ArcForges Cloud** | The continuity and remote-execution platform: an ASP.NET Core **JIT modular monolith** (**D-008**), one deployment host with bounded internal work, dependency posture, environments, deployment, operations, resilience and go-live threshold |
