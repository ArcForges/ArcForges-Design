...
| [`arcchat-mobile-and-web.md`](arcchat-mobile-and-web.md) | **ArcChat Mobile / ArcChat Web** | Cloud continuity and remote-agent companion — Apache-2.0 mobile boundary (**[D-004](../../decisions/phase-1-foundation-decisions.md#rule-d-004)**), Android on Kotlin/Jetpack Compose with iOS outside scope (**[D-008](../../decisions/phase-1-foundation-decisions.md#rule-d-008)**), consumption-only commerce (**[D-022](../../decisions/phase-1-foundation-decisions.md#rule-d-022)**) |
