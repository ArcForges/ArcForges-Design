...
| <a id="rule-ao-05"></a>AO-05 | Native AOT gates apply to every desktop and C# Cloud deliverable and their complete managed dependency closures under [P2-009](../decisions/phase-2-specification-decisions.md#rule-p2-009). Kotlin/Jetpack Compose and browser assets have their own measured release gates. |
