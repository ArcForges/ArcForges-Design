...
| Is any figure compiled into a specification as a constant? | **No.** [WP-42.01](../planning/work-packages/42-commerce-entitlement-and-credits.md#rule-wp-42.01)'s completion gate is a scan asserting no commercial constant is compiled into code, and [BR-02](../planning/work-packages/42-commerce-entitlement-and-credits.md#rule-br-02) of that package forbids it |
...
| CN-03 | **[D-020](../decisions/phase-1-foundation-decisions.md#rule-d-020)'s verification and approval requirement is therefore not yet triggered** for any figure, consistent with **[D-003](../decisions/phase-1-foundation-decisions.md#rule-d-003)**'s first-consumption rule. |
