...
| **[D-011](../decisions/phase-1-foundation-decisions.md#rule-d-011)** | Original repository inventory, amended to ten owners by [P2-009](../decisions/phase-2-specification-decisions.md#rule-p2-009) | `implementation-state-reconciliation.md` — **item-level, 166 projects** | Solution layout `§1`; [WP-01](../planning/work-packages/01-repository-reconciliation-and-target-layout.md#rule-wp-01) | [PG-02](open-gates-register.md#rule-pg-02) **closed** by that evidence |
