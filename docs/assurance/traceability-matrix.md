...
| **[V-03](phase-1-official-verification.md#rule-v-03)** | Cloud runtime posture | `../architecture/05-cloud-architecture.md` `§1` | [VG-06](open-gates-register.md#rule-vg-06) now requires full Cloud AOT closure under [P2-009](../decisions/phase-2-specification-decisions.md#rule-p2-009) | [WP-06.04](../planning/work-packages/06-aot-jit-and-wasm-publish-proof.md#rule-wp-06.04), [WP-21.00](../planning/work-packages/21-cloud-host-and-persistence.md#rule-wp-21.00) |
| **[V-04](phase-1-official-verification.md#rule-v-04)** | Android runtime posture | `../architecture/11-mobile-architecture.md` `§3` | [VG-07](open-gates-register.md#rule-vg-07) artifact confirmation; [VG-08](open-gates-register.md#rule-vg-08) upgrade re-verification; [VG-09](open-gates-register.md#rule-vg-09) iOS activation | [WP-06.07](../planning/work-packages/06-aot-jit-and-wasm-publish-proof.md#rule-wp-06.07), [WP-30.02](../planning/work-packages/30-mobile-shared-architecture.md#rule-wp-30.02), [WP-32.01](../planning/work-packages/32-mobile-release-and-store-gates.md#rule-wp-32.01), [WP-02.05](../planning/work-packages/02-build-governance-and-analyzer-policy.md#rule-wp-02.05), deferred |
...
| **[V-05e](phase-1-official-verification.md#rule-v-05e)** | Cloud dependency set under AOT | `../architecture/05-cloud-architecture.md` `§1` | [VG-06](open-gates-register.md#rule-vg-06) — full production Native AOT closure | [WP-06.04](../planning/work-packages/06-aot-jit-and-wasm-publish-proof.md#rule-wp-06.04), [WP-21.00](../planning/work-packages/21-cloud-host-and-persistence.md#rule-wp-21.00), [WP-50.04](../planning/work-packages/50-full-platform-production-release.md#rule-wp-50.04) |
...
[P2-008](../decisions/phase-2-specification-decisions.md#rule-p2-008) supersedes the original Web technology while preserving the existing product/Cloud scope. [P2-003](../decisions/phase-2-specification-decisions.md#rule-p2-003) is adopted. This table extends the earlier baseline mapping.

| Requirement / decision | Architecture / producer | Implementation verification |
|---|---|---|
| React/TS, Node/npm, esproj/portable monorepo | [Web toolchain](../architecture/25-web-toolchain-and-sdk.md), solution/build architecture; [WP-01](../planning/work-packages/01-repository-reconciliation-and-target-layout.md#rule-wp-01), [WP-02](../planning/work-packages/02-build-governance-and-analyzer-policy.md#rule-wp-02) | [WP-05](../planning/work-packages/05-architecture-and-repository-policy-tests.md#rule-wp-05), [WP-06](../planning/work-packages/06-aot-jit-and-wasm-publish-proof.md#rule-wp-06) and [WP-50.06](../planning/work-packages/50-full-platform-production-release.md#rule-wp-50.06); Windows solution plus independent non-Windows npm commands |
| proto → generated descriptors → generated TS SDK | [Contracts](../architecture/02-contracts-and-protocols.md), toolchain §3; [WP-03](../planning/work-packages/03-contract-foundation-and-licence-split.md#rule-wp-03), [WP-04](../planning/work-packages/04-identity-error-and-versioning-primitives.md#rule-wp-04) | [WP-23.05](../planning/work-packages/23-public-api-and-generated-clients.md#rule-wp-23.05) real C#/TS round trips, exact numbers and compatibility |
| Cookie-session authority and browser isolation | [Web §5](../architecture/10-web-architecture.md#5-browser-session-architecture--p2-003-resolved), Identity storage and browser-session catalogue; [WP-22.08](../planning/work-packages/22-identity-workspace-and-device.md#rule-wp-22.08) | [WP-48.01](../planning/work-packages/48-account-portal.md#rule-wp-48.01) real origin/CSRF/expiry/revocation/passkey/replica evidence |
| Shared event semantics | [Realtime catalogue](../architecture/contracts/03-realtime-and-bridge.md); [WP-24.06](../planning/work-packages/24-realtime-and-reliable-events.md#rule-wp-24.06) | Both client languages and [WP-49.01](../planning/work-packages/49-arcchat-web-companion.md#rule-wp-49.01) stream/reconnect/polling checks |
...
|---|---|---|
| Per-application assistant and history | req00/arcchat; model05; arch27 | WP15/17/52.05: isolated stores/sessions, offline archive, explicit promotion and lost-ack recovery |
| Native identity and PAT | req02; contracts00/07; arch08 | WP22.01/.05/.07: exact PKCE/RP/redirect/actor scope and real email evidence |
| Generated complete API and private children | registry04/annex09/10/11 | WP03/06/23: descriptor/scope/metadata equality, actual gRPC-Web and launch-bound IPC |
