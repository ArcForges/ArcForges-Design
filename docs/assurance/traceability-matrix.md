...
| NC-10 | **This matrix was rechecked on 2026-09-07** after the design-defect repair pass. [WP-52](../planning/work-packages/52-cloud-harness.md#rule-wp-52) was created at its real dependency position, and the sub-steps relocated into it ([WP-17.08](../planning/work-packages/17-arcchat-independent-core.md#rule-wp-17.08), [WP-17.09](../planning/work-packages/17-arcchat-independent-core.md#rule-wp-17.09), [WP-17](../planning/work-packages/17-arcchat-independent-core.md#rule-wp-17)) are retired at their old identifiers rather than left as dangling citations. |
