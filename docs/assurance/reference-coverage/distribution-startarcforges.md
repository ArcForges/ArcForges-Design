...
| F-SD-4 | **A software rasteriser is shipped, not merely assumed** ([SD-08](#rule-sd-08)). | Supports [GP-04](../../architecture/12-native-interop-and-media.md#rule-gp-04). No change needed. |
