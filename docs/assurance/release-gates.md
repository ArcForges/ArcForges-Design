...
| P-04 | Must-pass release scenarios pass for this product (`§27` there), including start with Cloud entirely offline and no sign-in gate |Scenario results |
| P-05 | Data format and portability obligations met: export produces a complete, re-importable package (`§10` of the data requirements) | Round-trip result |
