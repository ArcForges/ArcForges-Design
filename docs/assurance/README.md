...
| [open-gates-register.md](open-gates-register.md) | The authoritative register: 38 entries, five design closures, 32 open implementation obligations including two dormant entries, one merged entry and zero unresolved owner determinations |
